...
impl Round2 {
    ...
    where
        O: Push<Msg<(VerifiableSS<Secp256k1, sha2::Sha256>, Scalar<Secp256k1>)>>,
    {
...
pub struct Round3 {
    ...
    own_vss: VerifiableSS<Secp256k1, sha2::Sha256>,
...
impl Round3 {
    pub fn proceed<O>(
        self,
        input: P2PMsgs<(VerifiableSS<Secp256k1, sha2::Sha256>, Scalar<Secp256k1>)>,
        mut output: O,
    ) -> Result<Round4>
    where
    ...
    pub fn expects_messages(
        i: u16,
        n: u16,
    ) -> Store<P2PMsgs<(VerifiableSS<Secp256k1, sha2::Sha256>, Scalar<Secp256k1>)>> {
...
pub struct Round4 {
    ...
    vss_vec: Vec<VerifiableSS<Secp256k1, sha2::Sha256>>,
...
pub struct LocalKey<E: Curve> {
    ...
    pub vss_scheme: VerifiableSS<E, sha2::Sha256>,
    pub i: u16,
    pub t: u16,
    pub n: u16,
}
