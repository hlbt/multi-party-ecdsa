...
impl Keys {
    ...
    ) -> Result<(VerifiableSS<Secp256k1, sha2::Sha256>, Vec<Scalar<Secp256k1>>, u16), Error> {
        // test length:
    ...
    pub fn update_commitments_to_xi(
        ...
        let li =
            VerifiableSS::<Secp256k1, sha2::Sha256>::map_share_to_new_params(&vss_scheme.parameters, index, s);
        comm * &li
    }
